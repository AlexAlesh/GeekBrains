...
list_data = ['инженер-конструктор Игорь', 'главный бухгалтер МАРИНА', 'токарь высшего разряда нИКОЛАй', 'директор аэлита']
for i in list_data:
    idx = list_data.index(i)
    obj = list_data[idx]
    obj_1 = obj.split(' ')
    big = obj_1[-1]
    print(f'Привет, {big.capitalize()}')
